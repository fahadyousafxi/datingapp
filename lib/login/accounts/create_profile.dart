...
class _CreateProfileState extends State<CreateProfile> {
  ...
  final TextEditingController _whatAmILookingForController =
        ...
        child: Form(
          ...
          child: Column(
            children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: notifire.getdarkpinkscolor),
                          ),
                          child: Center(
                  ...
                  child: TextFormField(
                    ...
                    validator: (String? txt) {
                      if (txt == null || txt.isEmpty) {
                        return "Please Provide About You";
                      }
                      return null;
                    },
                    maxLines: 3,
                    style: TextStyle(
                        fontSize: 15.0, color: notifire.getdarkscolor),
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide:
                            BorderSide(color: notifire.getdarkpinkscolor),
              ...
              textfields(CustomStrings.address, _addressController,
                  (String? txt) {
                if (txt == null || txt.isEmpty) {
                  return "Please provide your Address";
                }
                return null;
              }, img: "image/locations.png"),
              SizedBox(
                height: height / 70,
              ),
              Row(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: DropdownButton(
                              ...
                              items:
                                  maritalStatusItems.map((String seconditems) {
                                return DropdownMenuItem(
                                  value: seconditems,
                                  child: Text(
                                    seconditems,
              ...
              textfields('Profession', _professionController, (String? txt) {
                if (txt == null || txt.isEmpty) {
                  return "Please provide your Profession";
                }
                return null;
              }),
              SizedBox(
              ...
              Padding(
                ...
                child: Container(
                  child: TextFormField(
                    controller: _whatAmILookingForController,
                    validator: (String? txt) {
                      if (txt == null || txt.isEmpty) {
                        return "Please provide What do you Looking For";
                      }
                      return null;
                    },
                    maxLines: 3,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: DropdownButton(
                              ...
                              // ),
                              items:
                                  noOfChildrenItems.map((String seconditems) {
                                return DropdownMenuItem(
                                  value: seconditems,
                                  child: SizedBox(
                                    width: width / 2.3 - 50,
              ...
              Padding(
                ...
                child: Container(
                  child: TextFormField(
                    ...
                    validator: (String? txt) {
                      if (txt == null || txt.isEmpty) {
                        return "Did You Have Any Health Issues?";
                      }
                      return null;
                    },
                    maxLines: 3,
  ...
  Widget textfields(txt, controller, validator, {img}) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: width / 18),
      child: Container(
        child: TextFormField(
